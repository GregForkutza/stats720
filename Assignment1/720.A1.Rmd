...
**BMB**: there's a built-in `cov2cor()` function ... 
...
**BMB**: in general I would avoid doing things "both ways". Sometimes OK for pedagogical purposes.  Usually only one or the other makes sense, and doing things both ways exposes you to snooping potential.  If units are different then PCA based on cov matrix **almost never** makes sense.

**BMB**: PCA is OK. This *might* be an acceptable use of VIFs, although I generally don't like them ...
...
**BMB**: you did a good job describing how R's contrasts work, but you never set up the custom contrast matrix I asked for ...
...
**BMB**: I'm puzzled about your results; at a glance your code looks OK, but your coverage is uniformly terrible (it should be nominal at violation level = 1); BP test power should be 0.05 for violation level 1 and increase, etc.. Something funky going on there.

Mark: 8 (you missed a big part of Q2, everything else looks OK
